...
t.login = {}
t.login.language = '語言'
t.login.motto = '時間是一切財富中最寶貴的財富'
t.login.form = {}
t.login.form.placeholderUsername = '用戶名'
t.login.form.placeholderPassword = '密碼'
t.login.form.placeholderCaptcha = '驗證碼'
t.login.form.textSubmitButton = '登入'
t.login.form.textForget = '忘記密碼'
t.login.form.textSignUp = '註冊用戶'
t.login.footer = {}
t.login.footer.buttonHelp = '幫助'
t.login.footer.buttonPrivacy = '隱私'
t.login.footer.buttonClause = '條款'
t.login.copyright = {}
t.login.copyright.p1 = 'Copyright'
t.login.copyright.p2 = '2018 D2 Projects 開源組織出品'
